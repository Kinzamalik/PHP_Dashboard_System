				...
				<td>
					...
					<td>
						<a href="#editEmployeeModal" class="edit" data-toggle="modal">
							...
							data-city="<?php echo $row["age"]; ?>"
							data-city="<?php echo $row["gender"]; ?>"
			...
			<div class="modal-content">
				<form id="update_form">
					...
					<div class="modal-body">
                        ...
                        <div class="form-group">
							<label>Age</label>
							<input type="age" id="age_u" name="age" class="form-control" required>
						</div>
                        <div class="form-group">
							<label>Gender</label>
							<input type="gender" id="gender_u" name="gender" class="form-control" required>
						</div>
					</div>
					<div class="modal-footer">
